    ...
    return (
        <div className="max-w-screen-xl mx-auto mt-12 px-4 text-gray-600 md:px-8 mb-32">
            <div className="hidden items-center justify-between sm:flex" aria-label="Pagination">
                <Link href={ createPageUrl( currentPage - 1 ) } className="hover:text-gray-900 flex items-center gap-x-2">
                            ...
                            <li key={ page + '-' + idx } className="text-sm">
                                {
                                    page == "..." ? (
                                        ...
                                        <Link href={ createPageUrl( page )} aria-current={currentPage == page ? "page" : false} className={`px-3 py-2 rounded-lg duration-150 hover:bg-gray-100 ${currentPage == page ? "bg-black text-white font-medium hover:bg-gray-950" : ""}`}>
                                            {page}
                                        </Link>
                                    )
                                }
